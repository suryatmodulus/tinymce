...
import { ContextToolbarGroupSpec, ContextToolbarGroup, createContextToolbarGroup } from '../components/content/ContextToolbarGroup';
...
export {
  ...
  ContextToolbarGroup,
  ContextToolbarGroupSpec,
  createContextToolbarGroup,
